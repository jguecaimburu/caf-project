...
Any `transform` property applied to an element will be overwritten if a style change is applied via Javascript so it's better to avoid this property on animated elements.
